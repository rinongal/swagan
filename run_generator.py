...
def generate_images(network_pkl, seeds, truncation_psi):
    ...
    for seed_idx, seed in enumerate(seeds):
        ...
        for noise_seed in range(1):
            z_pert = 0.05 * rnd.randn(1, *Gs.input_shape[1:]) # [minibatch, component]
            images = Gs.run(z + z_pert, None, **Gs_kwargs) # [minibatch, height, width, channel]
            PIL.Image.fromarray(images[0], 'RGB').save(dnnlib.make_run_dir_path('seed%04d_%04d.png' % (seed, noise_seed)))
