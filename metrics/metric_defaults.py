...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    #EasyDict(name='ppl_wfull', func_name='metrics.perceptual_path_length.PPL',     num_samples=5000, epsilon=1e-4, space='w', sampling='full', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    ...
    #EasyDict(name='ls',        func_name='metrics.linear_separability.LS',         num_samples=20000, num_keep=10000, attrib_indices=range(40), minibatch_per_gpu=4),
